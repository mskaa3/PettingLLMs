#!/bin/bash
#SBATCH --job-name=multi-grpo-lora
#SBATCH --nodes=2
...
export TRAIN_SCRIPT="${TRAIN_SCRIPT:-scripts/train/math/math_decomposer_selector_hybrid_separate.sh}"
export MODEL_0="${MODEL_0:-Qwen/Qwen3-8B}"
export MODEL_1="${MODEL_1:-Qwen/Qwen3-8B}"
export MODEL_2="${MODEL_2:-Qwen/Qwen3-8B}"
export DECOMPOSER_MODEL="${DECOMPOSER_MODEL:-${MODEL_0}}"
export SELECTOR_MODEL="${SELECTOR_MODEL:-${MODEL_1}}"
export WORKER_MODEL="${WORKER_MODEL:-${MODEL_2}}"
export DECOMPOSER_TRAINABLE="${DECOMPOSER_TRAINABLE:-true}"
export DECOMPOSER_OPTIMIZATION_MODE="${DECOMPOSER_OPTIMIZATION_MODE:-prompt}"
export SELECTOR_TRAINABLE="${SELECTOR_TRAINABLE:-true}"
export SELECTOR_OPTIMIZATION_MODE="${SELECTOR_OPTIMIZATION_MODE:-prompt}"
export WORKER_TRAINABLE="${WORKER_TRAINABLE:-true}"
export WORKER_OPTIMIZATION_MODE="${WORKER_OPTIMIZATION_MODE:-lora}"
export NUM_DECOMPOSITIONS="${NUM_DECOMPOSITIONS:-3}"
export NUM_SELECTIONS_PER_DECOMPOSITION="${NUM_SELECTIONS_PER_DECOMPOSITION:-3}"
...
export WANDB_NAME="${WANDB_NAME:-math_decomposer_selector_hybrid_lora_workers}"
export WANDB_MODE="${WANDB_MODE:-online}"
export PETTINGLLMS_PATCH_VERBOSE="${PETTINGLLMS_PATCH_VERBOSE:-0}"
export PETTINGLLMS_ENABLE_FILE_LOGS="${PETTINGLLMS_ENABLE_FILE_LOGS:-0}"
...
export APPTAINERENV_PETTINGLLMS_PATCH_VERBOSE="${PETTINGLLMS_PATCH_VERBOSE}"
export APPTAINERENV_PETTINGLLMS_ENABLE_FILE_LOGS="${PETTINGLLMS_ENABLE_FILE_LOGS}"
...
export APPTAINERENV_MODEL_1="${MODEL_1:-}"
export APPTAINERENV_MODEL_2="${MODEL_2:-}"
export APPTAINERENV_SHARED_MODEL="${SHARED_MODEL:-}"
export APPTAINERENV_ORCHESTRATOR_MODEL="${ORCHESTRATOR_MODEL:-}"
export APPTAINERENV_DECOMPOSER_MODEL="${DECOMPOSER_MODEL:-}"
export APPTAINERENV_SELECTOR_MODEL="${SELECTOR_MODEL:-}"
export APPTAINERENV_WORKER_MODEL="${WORKER_MODEL:-}"
export APPTAINERENV_ORCHESTRATOR_TRAINABLE="${ORCHESTRATOR_TRAINABLE:-}"
export APPTAINERENV_ORCHESTRATOR_OPTIMIZATION_MODE="${ORCHESTRATOR_OPTIMIZATION_MODE:-}"
export APPTAINERENV_DECOMPOSER_TRAINABLE="${DECOMPOSER_TRAINABLE:-}"
export APPTAINERENV_DECOMPOSER_OPTIMIZATION_MODE="${DECOMPOSER_OPTIMIZATION_MODE:-}"
export APPTAINERENV_SELECTOR_TRAINABLE="${SELECTOR_TRAINABLE:-}"
export APPTAINERENV_SELECTOR_OPTIMIZATION_MODE="${SELECTOR_OPTIMIZATION_MODE:-}"
export APPTAINERENV_WORKER_TRAINABLE="${WORKER_TRAINABLE:-}"
export APPTAINERENV_WORKER_OPTIMIZATION_MODE="${WORKER_OPTIMIZATION_MODE:-}"
export APPTAINERENV_NUM_DECOMPOSITIONS="${NUM_DECOMPOSITIONS:-}"
export APPTAINERENV_NUM_SELECTIONS_PER_DECOMPOSITION="${NUM_SELECTIONS_PER_DECOMPOSITION:-}"
