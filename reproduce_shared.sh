#!/bin/bash
#SBATCH --job-name=multi-grpo-shared
#SBATCH --nodes=2
...
export TRAIN_SCRIPT="${TRAIN_SCRIPT:-scripts/train/math/math_decomposer_selector_hybrid_shared.sh}"
export MODEL_0="${MODEL_0:-Qwen/Qwen3-8B}"
export MODEL_1="${MODEL_1:-${MODEL_0}}"
export ORCHESTRATOR_MODEL="${ORCHESTRATOR_MODEL:-${MODEL_0}}"
export WORKER_MODEL="${WORKER_MODEL:-${MODEL_1}}"
export ORCHESTRATOR_TRAINABLE="${ORCHESTRATOR_TRAINABLE:-true}"
export ORCHESTRATOR_OPTIMIZATION_MODE="${ORCHESTRATOR_OPTIMIZATION_MODE:-prompt}"
...
export WANDB_NAME="${WANDB_NAME:-math_decomposer_selector_hybrid_shared}"
